...
var that = this;
      ...
      if(flag)
      {
        ...
        var accountAdd = that.data.accountAdd

        accountAdd.Name = options.name;
        accountAdd.Title = options.title;
        accountAdd.TelPhone = options.TelPhone;
        accountAdd.MobilePhone = options.MobilePhone;
        accountAdd.GetGroupSend = options.GetGroupSend;
        accountAdd.Email = options.Email;
        accountAdd.QQ = options.QQ;
